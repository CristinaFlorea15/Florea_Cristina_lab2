...
namespace Florea_Cristina_Lab2.Migrations
{
    ...
    [Migration("20241107011429_Borrowings3")]
    partial class Borrowings3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Florea_Cristina_Lab2.Models.Author", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Florea_Cristina_Lab2.Models.Book", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Florea_Cristina_Lab2.Models.BookCategory", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Florea_Cristina_Lab2.Models.Member", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Florea_Cristina_Lab2.Models.Book", b =>
                {
                    b.HasOne("Florea_Cristina_Lab2.Models.Author", "Author")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Florea_Cristina_Lab2.Models.BookCategory", b =>
                {
                    ...
                    b.HasOne("Florea_Cristina_Lab2.Models.Category", "Category")
                        .WithMany("BookCategories")
                        .HasForeignKey("CategoryID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
